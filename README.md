# @platformbuilders/react-native-masked-text
...
`npm install @platformbuilders/react-native-masked-text --save`

`yarn @platformbuilders/react-native-masked-text`
...
-   Thanks to [benhurott](https://github.com/benhurott/react-native-masked-text). unfortunately it's not being maintained anymore, so we had to fork it! 
